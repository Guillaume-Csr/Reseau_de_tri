...
MyScene::MyScene(QObject *parent) : QGraphicsScene(parent)
{
    ...
    // Block test and sorting
    // if valor doesn't are in right order change with right color line
    ...
    // else trace black line to continue to next comparaison
    else
...
// If number change position keep his color to make line
